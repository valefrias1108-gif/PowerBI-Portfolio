...
**Objetivo:** Desarrollar un dashboard interactivo que permita el monitoreo en tiempo real de las cancelaciones y la cuantificación del costo estimado asociado a esta pérdida de clientes.
...
| Necesidad Central | Solución Propuesta en el Dashboard | Impacto Estratégico |
| :--- | :--- | :--- |
| **Monitoreo de la Cancelación** | KPI's claros sobre Tasa de cancelación, Costo de Cancelación y tendencias. | Seguimiento inmediato del estado de salud de la base de clientes. |
| **Segmentación de Clientes** | Filtros y segmentación demográfica/comportamental para identificar **clientes propensos a la cancelación**. | Formación de estrategias de retención *proactivas* (ej. ofertas de servicios alternativos). |
...
| :--- | :--- | :--- |
| **Extracción y Transformación (ETL)** | **Power Query (M Language)** | Limpieza, estructuración y combinación de datos de diversas fuentes (simuladas en .CSV o .XLSX) para el análisis. |
| **Modelado de Datos** | **Power BI Desktop** | Diseño de un modelo *estrella* optimizado para el cálculo de métricas de cancelación y costos. |
| **Cálculos y Métricas** | **DAX (Data Analysis Expressions)** | Creación de medidas clave, incluyendo: `Tasa de Churn`, `Costo Estimado de Cancelación`, `Tasa de Retención`, y métricas de crecimiento interanual. |
...
**Cuantificar el Riesgo:** Pasar de una percepción de pérdida a una medición precisa del impacto financiero de la cancelación.

**Actuar con Precisión:** Utilizar la segmentación para asignar recursos de retención solo a los segmentos de alto riesgo, optimizando el presupuesto de marketing y servicio al cliente.
...
**Correo Electrónico:** valefrias1108@gmail.com
